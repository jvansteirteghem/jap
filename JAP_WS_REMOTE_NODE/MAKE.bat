...
set JAP_WS_REMOTE_NODE_MODULUS_VERSION=2.0.0-SNAPSHOT
...
rem JAP_WS_REMOTE_NODE_MODULUS
mkdir JAP_WS_REMOTE_NODE_MODULUS-%JAP_WS_REMOTE_NODE_MODULUS_VERSION%
cd JAP_WS_REMOTE_NODE_MODULUS-%JAP_WS_REMOTE_NODE_MODULUS_VERSION%
copy ..\..\JAP_WS_REMOTE_NODE_MODULUS\JAP_WS_REMOTE.json JAP_WS_REMOTE.json
copy ..\..\JAP_WS_REMOTE_NODE_MODULUS\package.json package.json
copy ..\..\JAP_WS_REMOTE_NODE_MODULUS\README.txt README.txt
copy ..\..\JAP_WS_REMOTE_NODE_MODULUS\server.js server.js
mkdir JAP
cd JAP
copy ..\..\..\JAP\JAP_WS_REMOTE.js JAP_WS_REMOTE.js
cd ..
cd ..
%SEVENZIP_HOME%\7z.exe a -tzip JAP_WS_REMOTE_NODE_MODULUS-%JAP_WS_REMOTE_NODE_MODULUS_VERSION%.zip JAP_WS_REMOTE_NODE_MODULUS-%JAP_WS_REMOTE_NODE_MODULUS_VERSION%
