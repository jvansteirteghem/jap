...
set JAP_REMOTE_WS_NODE_DOTCLOUD_VERSION=2.0.0
...
rem JAP_REMOTE_WS_NODE_DOTCLOUD
mkdir JAP_REMOTE_WS_NODE_DOTCLOUD-%JAP_REMOTE_WS_NODE_DOTCLOUD_VERSION%
cd JAP_REMOTE_WS_NODE_DOTCLOUD-%JAP_REMOTE_WS_NODE_DOTCLOUD_VERSION%
copy ..\..\JAP_REMOTE_WS_NODE_DOTCLOUD\dotcloud.yml dotcloud.yml
copy ..\..\JAP_REMOTE_WS_NODE_DOTCLOUD\JAP_REMOTE_WS.js JAP_REMOTE_WS.js
copy ..\..\JAP_REMOTE_WS_NODE_DOTCLOUD\JAP_REMOTE_WS.json JAP_REMOTE_WS.json
copy ..\..\JAP_REMOTE_WS_NODE_DOTCLOUD\package.json package.json
copy ..\..\JAP_REMOTE_WS_NODE_DOTCLOUD\Procfile Procfile
copy ..\..\JAP_REMOTE_WS_NODE_DOTCLOUD\README.txt README.txt
copy ..\..\JAP_REMOTE_WS_NODE_DOTCLOUD\supervisord.conf supervisord.conf
mkdir JAP
cd JAP
copy ..\..\..\JAP\JAP_REMOTE_WS.js JAP_REMOTE_WS.js
cd ..
cd ..
%SEVENZIP_HOME%\7z.exe a -tzip JAP_REMOTE_WS_NODE_DOTCLOUD-%JAP_REMOTE_WS_NODE_DOTCLOUD_VERSION%.zip JAP_REMOTE_WS_NODE_DOTCLOUD-%JAP_REMOTE_WS_NODE_DOTCLOUD_VERSION%
