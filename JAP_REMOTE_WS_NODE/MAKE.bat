...
set JAP_REMOTE_WS_NODE_VERSION=2.0.0
set JAP_REMOTE_WS_NODE_MODULUS_VERSION=2.0.0
set JAP_REMOTE_WS_NODE_NODEJITSU_VERSION=2.0.0
set JAP_REMOTE_WS_NODE_OPENSHIFT_VERSION=2.0.0
