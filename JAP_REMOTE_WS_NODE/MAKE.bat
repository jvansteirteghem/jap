...
set JAP_REMOTE_WS_NODE_MODULUS_VERSION=3.0.0-SNAPSHOT
set JAP_REMOTE_WS_NODE_NODEJITSU_VERSION=3.0.0-SNAPSHOT
set JAP_REMOTE_WS_NODE_OPENSHIFT_VERSION=3.0.0-SNAPSHOT
