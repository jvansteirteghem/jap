...
set JAP_WS_REMOTE_PYTHON_VERSION=2.0.0-SNAPSHOT
set JAP_WS_REMOTE_PYTHON_DOTCLOUD_VERSION=2.0.0-SNAPSHOT
set JAP_WS_REMOTE_PYTHON_OPENSHIFT_VERSION=2.0.0-SNAPSHOT
set JAP_WS_REMOTE_PYTHON_WINDOWS_VERSION=2.0.0-SNAPSHOT
