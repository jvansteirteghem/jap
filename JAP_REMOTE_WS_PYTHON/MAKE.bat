...
set JAP_REMOTE_WS_PYTHON_DOTCLOUD_VERSION=2.0.0
...
rem JAP_REMOTE_WS_PYTHON_DOTCLOUD
mkdir JAP_REMOTE_WS_PYTHON_DOTCLOUD-%JAP_REMOTE_WS_PYTHON_DOTCLOUD_VERSION%
cd JAP_REMOTE_WS_PYTHON_DOTCLOUD-%JAP_REMOTE_WS_PYTHON_DOTCLOUD_VERSION%
copy ..\..\JAP_REMOTE_WS_PYTHON_DOTCLOUD\dotcloud.yml dotcloud.yml
copy ..\..\JAP_REMOTE_WS_PYTHON_DOTCLOUD\JAP_REMOTE_WS.json JAP_REMOTE_WS.json
copy ..\..\JAP_REMOTE_WS_PYTHON_DOTCLOUD\JAP_REMOTE_WS.py JAP_REMOTE_WS.py
copy ..\..\JAP_REMOTE_WS_PYTHON_DOTCLOUD\README.txt README.txt
copy ..\..\JAP_REMOTE_WS_PYTHON_DOTCLOUD\requirements.txt requirements.txt
mkdir JAP
cd JAP
copy ..\..\..\JAP\__init__.py __init__.py
mkdir REMOTE_WS
...
cd ..
cd ..
%SEVENZIP_HOME%\7z.exe a -tzip JAP_REMOTE_WS_PYTHON_DOTCLOUD-%JAP_REMOTE_WS_PYTHON_DOTCLOUD_VERSION%.zip JAP_REMOTE_WS_PYTHON_DOTCLOUD-%JAP_REMOTE_WS_PYTHON_DOTCLOUD_VERSION%
