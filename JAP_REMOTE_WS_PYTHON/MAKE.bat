...
set JAP_REMOTE_WS_PYTHON_VERSION=3.0.0-SNAPSHOT-3
set JAP_REMOTE_WS_PYTHON_OPENSHIFT_VERSION=3.0.0-SNAPSHOT-3
set JAP_REMOTE_WS_PYTHON_WINDOWS_VERSION=3.0.0-SNAPSHOT-3
